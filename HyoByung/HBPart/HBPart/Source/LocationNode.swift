...
open class LocationAnnotationNode: LocationNode {
    ...
    public init(location: CLLocation?, image: UIImage, r_id: String) {
        self.image = image
        ...
        annotationNode.name = r_id
        
        
//        annotationNode.runAction(SCNAction.rotateBy(x: 1, y: 1, z: 0, duration: 1))
//        annotationNode.method(for: <#T##Selector!#>)
